...
export class Settings implements OnInit {
   ...
   // REWARD POINTS
    ...
    settings: any = { max_price : 1000 };

    constructor(public translate: TranslateService, public api: Service, public toastController: ToastController) {
        this.customer.billing = {};
        this.customer.shipping = {};
        this.theme.tabBar = 'white';
        this.theme.header = 'white';
        this.theme.button = 'success';
    }
    ngOnInit() {}
